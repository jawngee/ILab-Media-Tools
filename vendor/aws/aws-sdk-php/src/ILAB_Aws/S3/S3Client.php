...
use ILAB_Aws\Common\Client\AbstractClient;
use ILAB_Aws\Common\Client\ClientBuilder;
use ILAB_Aws\Common\Client\ExpiredCredentialsChecker;
use ILAB_Aws\Common\Client\UploadBodyListener;
use ILAB_Aws\Common\Enum\ClientOptions as Options;
use ILAB_Aws\Common\Exception\RuntimeException;
use ILAB_Aws\Common\Exception\InvalidArgumentException;
use ILAB_Aws\Common\Signature\SignatureV4;
use ILAB_Aws\Common\Model\MultipartUpload\AbstractTransfer;
use ILAB_Aws\S3\Exception\AccessDeniedException;
use ILAB_Aws\S3\Exception\Parser\S3ExceptionParser;
use ILAB_Aws\S3\Exception\S3Exception;
use ILAB_Aws\S3\Model\ClearBucket;
use ILAB_Aws\S3\Model\MultipartUpload\AbstractTransfer as AbstractMulti;
use ILAB_Aws\S3\Model\MultipartUpload\UploadBuilder;
use ILAB_Aws\S3\Sync\DownloadSyncBuilder;
use ILAB_Aws\S3\Sync\UploadSyncBuilder;
...
class S3Client extends AbstractClient
{
     ...
     * @param $config
     *
     * @return \ILAB_Aws\Common\Signature\SignatureInterface
