...
namespace ILAB_Aws\Common\Hash;

use ILAB_Aws\Common\Enum\Size;
use ILAB_Aws\Common\Exception\InvalidArgumentException;
use ILAB_Aws\Common\Exception\LogicException;
...
class TreeHash implements ChunkHashInterface
{
    ...
    public static function fromChecksums(array $checksums, $inBinaryForm = false, $algorithm = self::DEFAULT_ALGORITHM)
    {
        ...
        $treeHash->checksums = $inBinaryForm ? $checksums : array_map('ILAB_Aws\Common\Hash\HashUtils::hexToBin', $checksums);
