...
namespace ILAB_Aws\Common\Client;

use ILAB_Aws\Common\Credentials\Credentials;
use ILAB_Aws\Common\Credentials\CredentialsInterface;
use ILAB_Aws\Common\Credentials\NullCredentials;
use ILAB_Aws\Common\Enum\ClientOptions as Options;
use ILAB_Aws\Common\Exception\ExceptionListener;
use ILAB_Aws\Common\Exception\InvalidArgumentException;
use ILAB_Aws\Common\Exception\NamespaceExceptionFactory;
use ILAB_Aws\Common\Exception\Parser\DefaultXmlExceptionParser;
use ILAB_Aws\Common\Exception\Parser\ExceptionParserInterface;
use ILAB_Aws\Common\Iterator\AwsResourceIteratorFactory;
use ILAB_Aws\Common\RulesEndpointProvider;
use ILAB_Aws\Common\Signature\EndpointSignatureInterface;
use ILAB_Aws\Common\Signature\SignatureInterface;
use ILAB_Aws\Common\Signature\SignatureV2;
use ILAB_Aws\Common\Signature\SignatureV3Https;
use ILAB_Aws\Common\Signature\SignatureV4;
...
class ClientBuilder
{
    ...
    public function __construct($namespace = null)
    {
        ...
        $this->clientClass = 'ILAB_Aws\Common\Client\DefaultClient';
    ...
    protected function getSignature(ServiceDescription $description, Collection $config)
    {
        ...
        if (is_string($signature)) {
            ...
            throw new InvalidArgumentException('The provided signature is not '
                ...
                . 'ILAB_Aws\\Common\\Signature\\SignatureInterface');
        }
