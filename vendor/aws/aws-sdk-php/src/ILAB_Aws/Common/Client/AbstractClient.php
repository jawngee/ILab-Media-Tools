...
use ILAB_Aws\Common\Exception\TransferException;
...
use ILAB_Aws\Common\Signature\SignatureListener;
use ILAB_Aws\Common\Waiter\WaiterClassFactory;
use ILAB_Aws\Common\Waiter\CompositeWaiterFactory;
use ILAB_Aws\Common\Waiter\WaiterFactoryInterface;
use ILAB_Aws\Common\Waiter\WaiterConfigFactory;
...
abstract class AbstractClient extends Client implements AwsClientInterface
{
    ...
    /**
     * {@inheritdoc}
     * @throws \ILAB_Aws\Common\Exception\TransferException
     */
